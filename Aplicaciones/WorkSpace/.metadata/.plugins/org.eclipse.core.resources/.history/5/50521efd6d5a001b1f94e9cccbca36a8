...
public class Pedido {
	...
	public String setDisplayElementsHTML() {
		...
		texto += "<html>" + "<div  style=\"font-size:12px;\">" + "<h2><center>Pedido " + this.id + "</center></h2>\r\n"
				+ "	\r\n" + "	<p style=\"font-family:arial;margin:auto;\">\r\n" + "		<u>Usuario</u>: "
				+ this.user.getName() + " (" + this.user.getID() + ")<br>\r\n" + "		<u>Fecha</u>: " + this.getDia()
				...
				+ "		  </tr>\r\n" + "		</table>\r\n" + "		<hr>\r\n"
				+ "		<div style=\"font-family:arial;\"><u>Punto de entrega</u>: " + this.destino + "." + "</div>"
				+ "</div></html>";
