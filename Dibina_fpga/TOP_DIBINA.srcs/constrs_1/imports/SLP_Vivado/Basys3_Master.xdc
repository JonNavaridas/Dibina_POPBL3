...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {rec_sac}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {rec_sac}]
...
set_property PACKAGE_PIN V7 [get_ports punto]							
	set_property IOSTANDARD LVCMOS33 [get_ports punto]
...
##Buttons
#set_property PACKAGE_PIN U18 [get_ports btn_OFF]						
#	set_property IOSTANDARD LVCMOS33 [get_ports btn_OFF] 
set_property PACKAGE_PIN T18 [get_ports confirmar]						
	set_property IOSTANDARD LVCMOS33 [get_ports confirmar]
set_property PACKAGE_PIN W19 [get_ports recibir]						
	set_property IOSTANDARD LVCMOS33 [get_ports recibir] 
set_property PACKAGE_PIN T17 [get_ports sacar]						
	set_property IOSTANDARD LVCMOS33 [get_ports sacar] 
set_property PACKAGE_PIN U17 [get_ports denegar]						
	set_property IOSTANDARD LVCMOS33 [get_ports denegar]
